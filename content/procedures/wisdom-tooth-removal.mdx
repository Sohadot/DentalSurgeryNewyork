...
Any cost discussion on this page is directional context, not a quote. Patients should request a written estimate that separates consultation, imaging, extraction type, sedation, medications, and follow-up care.

## Sedation Questions Matter

Patients are often focused on the extraction itself, but sedation questions are equally important. Patients should understand:
